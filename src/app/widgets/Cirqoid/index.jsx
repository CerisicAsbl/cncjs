...
class CirqoidWidget extends PureComponent {
    static propTypes = {
    ...
    controllerEvents = {
        'serialport:open': (options) => {
            ...
            this.setState({
                isReady: controllerType === CIRQOID,
                port: port
            });
        },
    ...
    getInitialState() {
        return {
            ...
            isFullscreen: false,
            isReady: (controller.loadedControllers.length === 1) || (controller.type === CIRQOID),
